    ...
    <section class="content-header">
        <div class="container-fluid">
            <nav aria-label="breadcrumb">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="text-gray-800"><i class="fas fa-envelope"></i> Edit Surat Masuk
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php foreach ($suratMasuk as $rows) : ?>
                        <form method="post" action="<?php echo base_url('surat_masuk/update'); ?>" enctype="multipart/form-data" class="ml-4 mr-4 mt-3 mb-3">
