							...
							foreach ($suratMasuk as $row) : ?>
								...
								<tr>
									...
									<td width="200px" class="text-center">
										<a href="<?php echo base_url() ?>surat_masuk/detail/<?php echo $row->id_surat_masuk ?>" class="btn btn-sm btn-success" title="Detail"><i class="fas fa-plus-circle"></i> Detail</a>
										<a onclick="javascript:return confirm('apakah anda yakin akan dihapus ?');" href="<?php echo base_url('Surat_masuk/delete/') . $row->id_surat_masuk ?>" class="btn btn-sm btn-danger ml-2" title="Hapus"><i class="fa fa-trash"></i> Hapus</a>
									</td>
								</tr>
