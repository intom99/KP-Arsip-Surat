                    ...
                    <?php foreach ($karyawan as $row) : ?>
                        <form method="post" action="<?php echo base_url('administrator/karyawan/update') ?>" class="ml-4 mr-4 mt-3 mb-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="id_karyawan" class="form-control" value="<?php echo $row->id_karyawan ?>">
                                <input type="text" name="nama_karyawan" placeholder=" Masukkan Nama" class="form-control" value="<?php echo $row->nama_karyawan ?>">
