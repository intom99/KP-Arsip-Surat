    ...
    <section class="content-header">
        <div class="container-fluid">
            <nav aria-label="breadcrumb">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="text-gray-800"><i class="fas fa-folder"></i> Laporan Surat Masuk</h1>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="col-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a class="btn btn-primary mt-5" href="<?php echo base_url('Arsip_surat_masuk') ?>" onclick="document.getElementById('form_[form_key]').reset();"><i class="fas fa-sync"></i> Reset</a>
                        </div>
                    </div>
                    ...
                    <div id="div1" style="display:none">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <hr>
                                <form action="<?php echo base_url('Arsip_surat_masuk/print') ?>" method="post" target="_blank">
